...
from modules import shared, modelloader, devices, script_callbacks, sd_vae, errors # sd_disable_initialization
...
def read_state_dict(checkpoint_file, print_global_state=False, map_location=None):
    _, extension = os.path.splitext(checkpoint_file); map_location='cuda' if os.path.getsize(checkpoint_file) > 5500000000 else map_location
